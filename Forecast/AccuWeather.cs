...
namespace Forecast
{
    public class AccuWeather : IForecast
    {
        ...
        public double GetSolarIrradianceNextHour()
        {
            ...
            var solarIrradiance = _forecast.FirstOrDefault(forecast => forecast.DateTime > currentDateTime).SolarIrradiance.Value;

            _logger.LogDebug($"AccuWeather - Solar Irradiance is {solarIrradiance} over the next hour");
